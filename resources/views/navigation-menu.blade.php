        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center" >
                    <a href="/" class="font-bold text-3xl text-gray-600" style="display: flex; gap: 8px">
                        <img src="{{asset('img/logo.png')}}" alt="Maxtdes" class="h-9 w-auto"> Maxtdes
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{route('admin.carousels.index')}}" :active="request()->routeIs('admin.carousels.index')">
                        Carrusel
                    </x-jet-nav-link>
